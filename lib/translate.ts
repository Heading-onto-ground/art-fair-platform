...
const dictionary: Dictionary = {
  ...
  // Main Page (Home)
  // ──────────────────────────────────────────
  home_badge: { en: "Art Activity Graph", ko: "예술 활동 그래프", ja: "アートアクティビティグラフ", fr: "Graphe d'Activité Artistique" },
  home_title: { en: "Role of Bridge", ko: "롤 오브 브릿지", ja: "ロール・オブ・ブリッジ", fr: "Role of Bridge" },
  home_subtitle: { en: "Record your exhibitions.\nBuild your art graph.\nBe discovered.", ko: "전시를 기록하세요.\n예술 그래프를 만드세요.\n발견되세요.", ja: "展示を記録する。\nアートグラフを築く。\n発見される。", fr: "Enregistrez vos expositions.\nConstituez votre graphe artistique.\nFaites-vous découvrir." },
  ...
  home_i_am_curator: { en: "I am a Curator", ko: "큐레이터입니다", ja: "キュレーターです", fr: "Je suis Curateur" },
  ...
  home_step1_title: { en: "Record", ko: "기록", ja: "記録", fr: "Enregistrer" },
  home_step1_desc: { en: "Log your exhibitions, collaborations, and series. Build your activity timeline.", ko: "전시, 협업, 시리즈를 기록하세요. 활동 타임라인을 만드세요.", ja: "展示、コラボレーション、シリーズを記録。活動タイムラインを構築。", fr: "Enregistrez vos expositions, collaborations et séries. Construisez votre timeline." },
  home_step2_title: { en: "Connect", ko: "연결", ja: "つながる", fr: "Connecter" },
  home_step2_desc: { en: "Every exhibition links artists, curators, and spaces — forming your art graph.", ko: "모든 전시가 작가, 큐레이터, 공간을 연결합니다 — 예술 그래프를 형성합니다.", ja: "すべての展示がアーティスト、キュレーター、スペースをつなぐ。", fr: "Chaque exposition relie artistes, commissaires et espaces — formant votre graphe." },
  home_step3_title: { en: "Be Discovered", ko: "발견되다", ja: "発見される", fr: "Être Découvert" },
  home_step3_desc: { en: "Curators and galleries find you through your activity data — not just your images.", ko: "큐레이터와 갤러리가 이미지가 아닌 활동 데이터로 당신을 발견합니다.", ja: "キュレーターやギャラリーが画像ではなく活動データからあなたを発見する。", fr: "Les commissaires vous trouvent grâce à vos données d'activité, pas seulement vos images." },
  ...
  home_for_curators: { en: "For Curators", ko: "큐레이터를 위해", ja: "キュレーターへ", fr: "Pour les Curateurs" },
  ...
  home_curator_title: { en: "Connect artists and institutions", ko: "작가와 기관을 연결하세요", ja: "アーティストと機関をつなぐ", fr: "Connectez artistes et institutions" },
  ...
  home_curator_feat1: { en: "Discover artists across borders", ko: "국경을 넘어 작가 발굴", ja: "国境を越えたアーティスト発掘", fr: "Découvrez des artistes au-delà des frontières" },
  home_curator_feat2: { en: "Curate exhibitions globally", ko: "글로벌 전시 기획", ja: "グローバル展覧会のキュレーション", fr: "Organisez des expositions mondiales" },
  home_curator_feat3: { en: "Connect with galleries & institutions", ko: "갤러리·기관과 네트워킹", ja: "ギャラリー・機関とのネットワーク", fr: "Connectez avec galeries et institutions" },
  home_curator_feat4: { en: "Manage exhibition records", ko: "전시 이력 관리", ja: "展覧会記録の管理", fr: "Gérez les archives d'exposition" },
  home_curator_feat5: { en: "Community & collaboration", ko: "커뮤니티 활동", ja: "コミュニティ活動", fr: "Communauté & collaboration" },
  ...
  oc_add_calendar: { en: "Add to Calendar", ko: "캘린더 추가", ja: "カレンダー追加", fr: "Ajouter au calendrier" },
  oc_calendar_short: { en: "Calendar", ko: "캘린더", ja: "カレンダー", fr: "Calendrier" },
  oc_tpl_short: { en: "Short template", ko: "짧은 템플릿", ja: "短いテンプレート", fr: "Modèle court" },
  oc_tpl_portfolio: { en: "Portfolio-focused", ko: "포트폴리오 강조", ja: "ポートフォリオ強調", fr: "Axé portfolio" },
  oc_tpl_local: { en: "Local context", ko: "지역 연결 강조", ja: "地域接続を強調", fr: "Contexte local" },
