  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "40px 24px 96px" }}>
        ...
        <h1 style={{ fontFamily: S, fontSize: 30, fontWeight: 300, color: colors.textPrimary, margin: "4px 0 8px" }}>모임 회차 기록</h1>
        <p style={{ fontFamily: F, fontSize: 13, color: colors.textSecondary, lineHeight: 1.7, margin: "0 0 28px" }}>
        ...
        <div style={{ border: `1px solid ${colors.border}`, background: colors.bgCard, padding: 24, marginBottom: 40 }}>
          ...
          <div style={{ position: "relative" }}>
            <input
              ...
              placeholder="작가 이름 또는 ID 검색 (2글자 이상)"
            />
